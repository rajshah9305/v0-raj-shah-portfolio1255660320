                            ...
                            <div className="grid grid-cols-3 gap-6 md:gap-10 mt-16 pt-10 border-t border-border">
                                {[
                                    ...
                                    <div key={stat.label} className="text-center group">
                                        ...
                                        <div className="font-mono text-xs md:text-sm text-foreground group-hover:text-foreground transition-colors duration-300 leading-tight tracking-normal">{stat.label}</div>
                                    </div>
                                ))}
                            </div>
                        </div>
            ...
            <section id="creations">
                ...
                <div className="text-center pb-16 px-6">
                    <a
                        ...
                        className="inline-flex items-center gap-3 px-8 py-4 border-2 border-foreground text-foreground font-mono text-base tracking-normal rounded-lg hover:bg-foreground hover:text-background transition-all duration-300"
                    >
