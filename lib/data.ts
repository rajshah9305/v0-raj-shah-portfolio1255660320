import { Github, Globe, Mail, Linkedin, Bot, Layers, Zap, Layout } from "lucide-react";
import type { Service, Project, Skill, TimelineEvent, SocialLink, PhilosophyItem } from "./types";
