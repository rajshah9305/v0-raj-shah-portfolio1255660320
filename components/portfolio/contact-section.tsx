...
import { Github, Globe, Mail, Send, MapPin } from "lucide-react";
  ...
  return (
    <div ref={containerRef} className="max-w-5xl mx-auto">
      <div className="grid md:grid-cols-2 gap-12 md:gap-16">
        ...
        >
          <p className="text-[#b0b0b0] text-lg leading-relaxed mb-8 font-serif">
          ...
          <div className="space-y-4">
            {socialLinks.map((link, i) => (
              ...
              >
                ...
                <div>
                  <div className="font-mono text-xs text-[#888]">{link.name}</div>
                  <div className="text-[#faf6f1] group-hover:text-[#e07a3c] transition-colors">{link.handle}</div>
                </div>
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block font-mono text-xs text-[#888] mb-2.5 uppercase tracking-wider">
                Name
              </label>
              <input
                type="text"
