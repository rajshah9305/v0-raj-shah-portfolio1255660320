    ...
    >
      ...
      <div className="relative z-20 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          {/* Chapter indicator */}
          <motion.p
            className="font-mono text-[10px] md:text-xs leading-normal tracking-[0.15em] font-medium text-white mb-6 md:mb-8"
            variants={fadeInUp}
          >
          ...
          <motion.div variants={fadeInUp} className="relative z-10">
            ...
            <div 
              className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-[40%] w-[200%] h-[200%] -z-10 pointer-events-none"
              aria-hidden="true"
            >
              {/* Core Glow */}
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,var(--primary)_0%,transparent_50%)] opacity-20 blur-3xl" />
              
              {/* God Rays */}
              <div 
                className="absolute inset-0 opacity-30 mix-blend-screen"
                style={{
                  background: "conic-gradient(from 0deg at 50% 50%, transparent 0deg, var(--primary) 20deg, transparent 40deg, transparent 140deg, var(--primary) 160deg, transparent 180deg, transparent 220deg, var(--primary) 240deg, transparent 260deg, transparent 320deg, var(--primary) 340deg, transparent 360deg)",
                  filter: "blur(60px)",
                }}
              />
              
              {/* Vertical Beam */}
              <div className="absolute inset-x-0 top-1/2 h-[50%] bg-gradient-to-b from-[var(--primary)]/20 to-transparent blur-3xl origin-top transform -scale-y-100 mix-blend-screen" />
            </div>

            <h1 className="mb-8 md:mb-12 relative">
              <span className="block text-foreground text-6xl md:text-9xl lg:text-[12rem] leading-[0.9] md:leading-[0.8] tracking-tight font-normal">RAJ</span>
              <span className="block text-primary text-6xl md:text-9xl lg:text-[12rem] leading-[0.9] md:leading-[0.8] tracking-tight font-normal">SHAH</span>
            </h1>
          </motion.div>
          ...
          >
            {["Full-Stack Developer", "AI Enthusiast", "Open-Source Advocate"].map((role) => (
              <motion.span
                ...
                className="px-3 md:px-4 py-2 md:py-2.5 border border-white/10 bg-black/40 backdrop-blur-md rounded-full text-label cursor-default"
              >
                {role}
              </motion.span>
            ))}
      ...
      >
        ...
        <div className="hidden md:block absolute bottom-8 right-8 text-foreground font-mono text-xs tracking-normal">
          49.2827°N ──┘
        </div>
      </motion.div>
    </motion.section>
