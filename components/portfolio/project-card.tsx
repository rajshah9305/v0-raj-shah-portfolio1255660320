    ...
    >
      <div className="relative h-full flex flex-col bg-card border border-border rounded-lg p-6 md:p-8 overflow-hidden transition-all duration-500 hover:border-primary/50 hover:shadow-[0_0_50px_rgba(224,122,60,0.1)]">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <span className="font-mono text-[10px] md:text-xs text-foreground group-hover:text-primary/70 transition-colors truncate tracking-normal">
        ...
        <div className="relative z-10 flex-grow flex flex-col justify-between">
          <div>
            ...
            <p className="text-foreground mb-8 line-clamp-3 group-hover:line-clamp-none transition-all duration-300">
              {description}
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-6 pt-6 border-t border-border/50 group-hover:border-primary/20 transition-colors">
              ...
              >
                ...
                <span className="font-mono text-sm tracking-normal">Source</span>
              </a>
              {liveUrl && (
                <a
                  href={liveUrl}
                ...
                >
                  ...
                  <span className="font-mono text-sm tracking-normal">Live Demo</span>
                </a>
              )}
            </div>
          </div>
