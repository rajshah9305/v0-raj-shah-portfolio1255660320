      ...
      <div className="relative h-full bg-[#181818] border border-[#333] rounded-lg p-6 md:p-8 overflow-hidden transition-all duration-500 hover:border-[#e07a3c] hover:shadow-[0_0_40px_rgba(224,122,60,0.15)]">
        ...
        <div className="relative z-10">
          <div className="flex items-start gap-3 mb-4">
            ...
            <h3 className="text-lg md:text-xl font-serif text-[#faf6f1] group-hover:text-[#e07a3c] transition-colors leading-tight">
              {title}
            </h3>
          </div>
          
          <p className="text-[#999] mb-6 leading-relaxed text-sm md:text-base">
            {description}
          </p>
          ...
          <div className="flex flex-wrap gap-2 mb-6">
            {tech.map((t) => (
              <span 
                key={t}
                className="px-2.5 py-1 bg-[#252525] text-[#aaa] text-xs font-mono rounded border border-[#333]"
              >
                {t}
              </span>
            ))}
